...
export class ExpenseController {
  ...
  createExpense(
    ...
    return this.expenseService.createExpense(createExpenseDto, tenantId);
  }

  @Get('statistics')
  @ApiOperation({ summary: 'Get overall profit and loss statistics' })
  @ApiResponse({ status: 200, description: 'Profit and loss statistics' })
  getProfitStatistics(@CurrentTenant() tenantId: string) {
    return this.expenseService.getProfitStatistics(tenantId);
  }
  ...
  findExpensesByBookingId(
    @Param('bookingId') bookingId: string,
    @CurrentTenant() tenantId: string,
  ) {
    return this.expenseService.findExpensesByBookingId(bookingId, tenantId);
  }
  ...
  findExpensesByPackageBookingId(
    @Param('packageBookingId') packageBookingId: string,
    @CurrentTenant() tenantId: string,
  ) {
    return this.expenseService.findExpensesByPackageBookingId(packageBookingId, tenantId);
  }
  ...
  updateExpense(
    ...
    return this.expenseService.updateExpense(id, updateExpenseDto, tenantId);
  }
